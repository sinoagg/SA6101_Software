...
#define  IDVDS_CFG_VD_STEP                7       /* control type: numeric, callback function: VdStepCallback */
#define  IDVDS_CFG_VD_STOP                8       /* control type: numeric, callback function: VdStCallback */
#define  IDVDS_CFG_VD_START               9       /* control type: numeric, callback function: VdSartCallback */
...
#define  IDVDS_CFG_VDRING                 13      /* control type: ring, callback function: ModeCallback */
...
#define  IDVDS_CFG_VG_STEP                20      /* control type: numeric, callback function: StepCallback */
#define  IDVDS_CFG_VG_STOP                21      /* control type: numeric, callback function: VdStopCallback */
#define  IDVDS_CFG_VG_START               22      /* control type: numeric, callback function: StartCallback */
...
#define  IDVDS_CFG_VDGRING                26      /* control type: ring, callback function: VdmodeCallbzck */
