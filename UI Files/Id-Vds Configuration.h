...
#define  IDVDS_CFG_VD_STEP_2              7       /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VD_STOP_2              8       /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VD_START_2             9       /* control type: numeric, callback function: (none) */
...
#define  IDVDS_CFG_RING_3                 13      /* control type: ring, callback function: (none) */
...
#define  IDVDS_CFG_VD_STEP                20      /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VD_STOP                21      /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VD_START               22      /* control type: numeric, callback function: (none) */
...
#define  IDVDS_CFG_RING_2                 26      /* control type: ring, callback function: (none) */
