...
#define  SAMPLE                           1
#define  SAMPLE_VG                        2       /* control type: numeric, callback function: (none) */
#define  SAMPLE_VD                        3       /* control type: numeric, callback function: (none) */
#define  SAMPLE_I                         4       /* control type: ring, callback function: (none) */
#define  SAMPLE_TEXTMSG_2                 5       /* control type: textMsg, callback function: (none) */
#define  SAMPLE_TEXTMSG                   6       /* control type: textMsg, callback function: (none) */
#define  SAMPLE_TEXTMSG_5                 7       /* control type: textMsg, callback function: (none) */
#define  SAMPLE_TEXTMSG_3                 8       /* control type: textMsg, callback function: (none) */
#define  SAMPLE_TEXTMSG_6                 9       /* control type: textMsg, callback function: (none) */
