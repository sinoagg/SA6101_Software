...
#define  IDVDS_CFG_RING_3                 12      /* control type: ring, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_26             13      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_RING                   14      /* control type: ring, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_2              15      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_15             16      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_17             17      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_DRAINMODE              18      /* control type: ring, callback function: IdVdDrainModeCallback */
#define  IDVDS_CFG_TEXTMSG_18             19      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_19             20      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TEXTMSG_20             21      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_PIC_DRAIN              22      /* control type: picture, callback function: IdVdDrainPicCallback */
#define  IDVDS_CFG_TEXTMSG_22             23      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_VG_STEP                24      /* control type: numeric, callback function: IdVdGateStepCallback */
#define  IDVDS_CFG_VG_STOP                25      /* control type: numeric, callback function: IdVdGateStopCallback */
#define  IDVDS_CFG_VG_START               26      /* control type: numeric, callback function: IdVdGateStartCallback */
#define  IDVDS_CFG_TEXTMSG_8              27      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TXT_STOP               28      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TXT_STEP               29      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_GATEMODE               30      /* control type: ring, callback function: IdVdGateModeCallback */
#define  IDVDS_CFG_MV_START               31      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_TXT_START              32      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_MV_STOP                33      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_PIC_GATE               34      /* control type: picture, callback function: IdVdGatePicCallback */
#define  IDVDS_CFG_MV_STEP                35      /* control type: textMsg, callback function: (none) */
#define  IDVDS_CFG_DECORATION_GATE        36      /* control type: deco, callback function: IdVdGateDecoCallback */
#define  IDVDS_CFG_DECORATION_DRAIN       37      /* control type: deco, callback function: IdVdDrainDecoCallback */
