...
int PlotCurve(GraphTypeDef* pGraph, int graphPanelHandle, int control)
{
	...
	{
		pGraph->plotHandle=PlotXY(graphPanelHandle, control, pGraph->pCurveArray->pDotXPlot, pGraph->pCurveArray->pDotYPlot, numOfDotsToPlot, VAL_FLOAT, VAL_FLOAT, VAL_CONNECTED_POINTS, VAL_DOTTED_SOLID_SQUARE, VAL_SOLID, 1, VAL_BLUE);
