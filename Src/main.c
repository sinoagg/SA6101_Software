...
{
	     char curve[80];
		 sprintf(curve,"%s%d","Curve",Graph1.plotCurveIndex);
		 //SetAnnotationAttribute (hGraphPanel,GRAPHDISP_GRAPH1,curveIndex , ATTR_ANNOTATION_VISIBLE, 0);    
...
{
	//rows  table中行的标志来量，每条曲线从(rows+1)=1开始到最后一个点;一条曲线结束时置0 
