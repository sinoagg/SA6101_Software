...
void DisplayEnvtGraph()
{
	...
	if((temp_flag)&&((Graph2.pCurveArray  + 1)->numOfPlotDots>=0))  
	{
		...
		CanvasDrawText (hGraphPanel, GRAPHDISP_CANVAS, "Temp",VAL_APP_META_FONT,MakeRect(40,15,15,70), VAL_CENTER);	                            //写"Temperature"
	...
	if((humidity_flag)&&(Graph2.pCurveArray->numOfPlotDots>=0))
	{						 
		
		SetCtrlAttribute (hGraphPanel, GRAPHDISP_CANVAS, ATTR_PEN_FILL_COLOR, VAL_WHITE);    //text背景色(与canvas颜色相同)
		SetCtrlAttribute (hGraphPanel, GRAPHDISP_CANVAS, ATTR_PEN_COLOR, VAL_BLACK);		 //"humidity"颜色
		CanvasDrawText (hGraphPanel, GRAPHDISP_CANVAS, "Hum",VAL_APP_META_FONT,MakeRect(60,15,15,70), VAL_CENTER);	                            //写"humidity"
	...
	if((pressure_flag)&&((Graph2.pCurveArray  + 2)->numOfPlotDots>=0)) 
	{
		
		SetCtrlAttribute (hGraphPanel, GRAPHDISP_CANVAS, ATTR_PEN_FILL_COLOR, VAL_WHITE);    //text背景色(与canvas颜色相同)
	    SetCtrlAttribute (hGraphPanel, GRAPHDISP_CANVAS, ATTR_PEN_COLOR, VAL_BLACK);		 //"pressure"颜色
	    CanvasDrawText (hGraphPanel, GRAPHDISP_CANVAS, "Press",VAL_APP_META_FONT,MakeRect(80,15,15,70), VAL_CENTER);	                            //写"pressure"
