...
#define  IDVGS_CFG_RING_3                 13      /* control type: ring, callback function: VgModeCallback */
...
#define  IDVGS_CFG_TXT_GATE               19      /* control type: textMsg, callback function: (none) */
#define  IDVGS_CFG_VG_STEP                20      /* control type: numeric, callback function: VGstepCallback */
#define  IDVGS_CFG_VG_STOP                21      /* control type: numeric, callback function: VGstopCallback */
#define  IDVGS_CFG_VG_START               22      /* control type: numeric, callback function: VGstartCallback */
#define  IDVGS_CFG_RING_MODE              23      /* control type: ring, callback function: VGmodeCallback */
