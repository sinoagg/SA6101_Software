...
#define  CHPANEL                          1
#define  CHPANEL_CHECKBOX                 2       /* control type: radioButton, callback function: GraphSelectCallback */
...
#define  SAVEDATA                         3       /* callback function: SaveDatePanelCallback */
#define  SAVEDATA_SHEETPATH               2       /* control type: string, callback function: (none) */
#define  SAVEDATA_TEXTMSG                 3       /* control type: textMsg, callback function: (none) */
#define  SAVEDATA_TEXTMSG_3               4       /* control type: textMsg, callback function: (none) */
#define  SAVEDATA_TEXTMSG_2               5       /* control type: textMsg, callback function: (none) */
#define  SAVEDATA_GRAPH2PATH              6       /* control type: string, callback function: (none) */
#define  SAVEDATA_GRAPH1PATH              7       /* control type: string, callback function: (none) */
#define  SAVEDATA_SAVEGRAPH1              8       /* control type: command, callback function: SaveGraph1Callback */
#define  SAVEDATA_SAVEALL                 9       /* control type: command, callback function: SaveAllCallback */
#define  SAVEDATA_SAVESHEET               10      /* control type: command, callback function: SaveSheetCallback */
#define  SAVEDATA_CANCEL                  11      /* control type: command, callback function: ExitCallback */
#define  SAVEDATA_BROWSEGRAPH2            12      /* control type: command, callback function: BrowseGraph2Callback */
#define  SAVEDATA_BROWSEGRAPH1            13      /* control type: command, callback function: BrowseGraph1Callback */
#define  SAVEDATA_BROWSESHEET             14      /* control type: command, callback function: BrowseSheetCallback */

#define  SAVETIP                          4
#define  SAVETIP_TEXTMSG                  2       /* control type: textMsg, callback function: (none) */
...
int  CVICALLBACK GraphSelectCallback(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK SaveDatePanelCallback(int panel, int event, void *callbackData, int eventData1, int eventData2);
