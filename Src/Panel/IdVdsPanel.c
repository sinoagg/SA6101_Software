...
//==============================================================================
// Global variables
ExpPanelTypeDef IdVdPanel={0, IDVDS_CFG_VD_START, IDVDS_CFG_VD_STOP, IDVDS_CFG_VD_STEP, IDVDS_CFG_VD_START, IDVDS_CFG_VD_STOP, IDVDS_CFG_VD_STEP, IDVDS_CFG_DRAINMODE, IDVDS_CFG_GATEMODE}; 
//==============================================================================
// Global functions
