...
#define  IDVDS_CFG_VD_STEP                7       /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VD_STOP                8       /* control type: numeric, callback function: (none) */
#define  IDVDS_CFG_VG_STEP                9       /* control type: numeric, callback function: (none) */
